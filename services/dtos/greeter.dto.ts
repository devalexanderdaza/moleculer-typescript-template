...
const generator = new OpenApiGeneratorV3([WelcomeSchema, WelcomeResponseSchema]);
const components = generator.generateComponents();

// Write to YAML file
writeFileSync(resolve(outputDirectory, "greeter-dto.swagger.yaml"), yaml.stringify(components));
